...
<div class="row-fluid" ng-controller="contactsController as ctrl">


<div allowed="ROLE_USER"><span > teeeeeee </span> </div>
<div allowed="ROLE_USER"><span > teeeeeee </span> </div>
...
<script src="<c:url value="/resources/old/js/pages/contacts.js" />"></script>